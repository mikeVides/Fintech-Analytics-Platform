...
df_silver.write \
    ...
    .save(f"{SILVER_PATH}/marketing_touches")

row_count = spark.read.format("delta").load(f"{SILVER_PATH}/marketing_touches").count()

print(f"Silver marketing_touches table written successfully.")
print(f"Total rows: {row_count:,}")
print(f"Columns: {spark.read.format('delta').load(f'{SILVER_PATH}/marketing_touches').columns}")